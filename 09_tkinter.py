...
def getvals():
    ...
    print(f"{namevalue.get(),phonevalue.get(),Gendervalue.get(),emergencyvalue.get(),emergencyvalue.get(),foodservicesvalue.get()}")
    with open("records.txt","a") as f:
        f.write(f"{namevalue.get(),phonevalue.get(),Gendervalue.get(),emergencyvalue.get(),emergencyvalue.get(),foodservicesvalue.get()}\n")
